...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans selection:bg-orange-100 selection:text-orange-600">
      ...
      {/* ====== HERO SECTION ====== */}
      <section className="py-20 px-4 md:px-8 lg:px-16 bg-gradient-to-b from-white to-orange-50/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-50 border border-orange-200 mb-6">
              ...
              <span className="text-orange-600 font-bold uppercase tracking-[0.2em] text-xs">Get in Touch</span>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div 
                key={idx}
                className="p-6 bg-white rounded-xl border border-gray-200 hover:border-orange-300 transition-colors duration-300"
              >
                <div className="w-12 h-12 bg-orange-50 rounded-lg flex items-center justify-center text-orange-600 mb-4">
                  {item.icon}
                </div>
                <h3 className="font-semibold text-gray-900 text-sm uppercase tracking-wide mb-2">{item.label}</h3>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  {status && (
                    <motion.div 
                      initial={{ opacity: 0 }} 
                      animate={{ opacity: 1 }} 
                      className={`p-3 rounded-lg text-center text-[9px] font-black uppercase tracking-[0.2em] border ${
                        status.includes('✅') 
