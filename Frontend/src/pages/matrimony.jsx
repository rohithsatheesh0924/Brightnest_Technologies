          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-8 md:gap-12">
            ...
            >
              ...
              >
                ...
                <span className="text-gray-600 font-medium whitespace-nowrap hidden sm:block">or</span>
                <a 
                  href="tel:+919342570575" 
                  className="text-orange-500 font-semibold hover:underline text-center sm:text-left"
                >
