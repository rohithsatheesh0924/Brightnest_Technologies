...
const WebDesignPage = () => {
  ...
  const [activeIndex, setActiveIndex] = useState(-1); // Initialize to -1 (no open FAQ)
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      {/* ====== HERO SECTION ====== */}
      <motion.section 
        className="bg-[#FFF2EA] py-12 md:py-16 px-4 sm:px-6 lg:px-8"
        initial="hidden"
        whileInView="visible"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12">
            <motion.div className="lg:w-1/2 text-center lg:text-left" variants={fadeInLeft}>
              ...
              <motion.p className="text-base md:text-lg mb-8 leading-relaxed" variants={staggerItem}>
              ...
              <motion.div className="flex flex-col sm:flex-row items-center gap-4 mt-8 justify-center lg:justify-start" variants={staggerItem}>
                <motion.button 
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={scrollToContactForm}
                  className="bg-orange-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-orange-600 transition-all duration-300 shadow-md whitespace-nowrap w-full sm:w-auto"
                >
                  Start Your Website Now →
                </motion.button>
                <span className="text-gray-600 hidden sm:block">or</span>
                <Link to="tel:+919342570575" className="text-orange-500 font-semibold hover:underline whitespace-nowrap text-center sm:text-left">
                  Call Us +91 9342570575
                </Link>
              </motion.div>
            </motion.div>
            <motion.div className="lg:w-1/2 flex justify-center mt-8 lg:mt-0" variants={fadeInRight}>
              <img 
                src="./web-des.png" 
      ...
      >
        <div className="max-w-6xl mx-auto">
          <motion.h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-8 md:mb-12" variants={fadeInUp}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {[
              ...
              <motion.div key={index} className="flex items-start space-x-3" variants={staggerItem}>
                ...
                <div dangerouslySetInnerHTML={{ __html: content }} className="text-sm md:text-base" />
              </motion.div>
            ))}
          </div>
          <motion.div className="mt-10 md:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 flex-wrap" variants={staggerItem}>
            <motion.button 
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={scrollToContactForm}
      ...
      <motion.section 
        className="py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-[#FFF2EA]"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.3 }}
        variants={staggerContainer}
      >
        <div className="max-w-6xl mx-auto">
          <motion.h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-8" variants={fadeInUp}>
          ...
          <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-center">
            <motion.div className="lg:w-1/2 order-2 lg:order-1" variants={fadeInLeft}>
              <motion.ul className="space-y-4 text-sm md:text-base" variants={staggerContainer}>
                {[
              ...
              <motion.div className="mt-8 flex flex-col sm:flex-row items-center gap-4" variants={staggerItem}>
                <motion.button 
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={scrollToContactForm}
            ...
            <motion.div className="lg:w-1/2 order-1 lg:order-2 flex justify-center" variants={fadeInRight}>
              <img 
                src="./developers.svg" 
                alt="Team Working" 
                className="max-w-full h-auto w-64 md:w-80 lg:w-full object-contain" 
      ...
      <motion.section 
        className="py-6 md:py-6 px-4 sm:px-6 lg:px-8 bg-white"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.3 }}
        variants={staggerContainer}
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-center">
            <motion.div className="lg:w-1/2 flex justify-center order-2 lg:order-1" variants={fadeInLeft}>
              <img 
                src="./teamwork.svg" 
            ...
            <motion.div className="lg:w-1/2 order-1 lg:order-2" variants={fadeInRight}>
              <motion.p className="text-sm md:text-base mb-4" variants={staggerItem}>
              ...
              <motion.div className="mt-8 flex flex-col sm:flex-row items-center gap-4 flex-wrap" variants={staggerItem}>
                <motion.button 
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={scrollToContactForm}
      ...
      >
        <div className="max-w-6xl mx-auto">
          <motion.h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-6" variants={fadeInUp}>
            Transform Your Online Business
          </motion.h2>
          <motion.p className="text-center text-base md:text-lg mb-8 md:mb-12 max-w-2xl mx-auto" variants={fadeInUp}>
            Discover Brightnest's Professional Website Solutions
          </motion.p>
          <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12">
            <motion.div className="lg:w-1/2 flex justify-center" variants={fadeInLeft}>
              <img 
                src="./web-top4.png" 
            ...
            <motion.div className="lg:w-1/2" variants={fadeInRight}>
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                onClick={scrollToContactForm}
                className="bg-orange-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-orange-600 transition-all duration-300 shadow-md mb-6 w-full sm:w-auto"
              >
                Explore Pricing →
              </motion.button>
              <motion.p className="text-gray-600 text-sm md:text-base mt-4" variants={staggerItem}>
