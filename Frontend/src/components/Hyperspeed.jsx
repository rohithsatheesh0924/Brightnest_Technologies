...
const Hyperspeed = ({
  effectOptions = {
    ...
    colors: {
  roadColor: 0x1a0f00,        // Dark orange-brown asphalt
  islandColor: 0x2a1800,      // Slightly lighter central divider
  background: 0x000000,       // Keep black night sky
  shoulderLines: 0xffa500,    // Classic orange lines
  brokenLines: 0xff8c00,      // Darker orange for contrast
  leftCars: [
    0xff6b35,  // Vibrant orange
    0xff8c42,  // Orange-copper
    0xff4500   // Deep burnt orange
  ],
  rightCars: [
    0xffa500,  // Pure orange
    0xff7f00,  // Dark orange
    0xff9500   // Medium orange
  ],
  sticks: 0xff6b35           // Bright orange accent
}
