          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                Our expert team will guide you through a seamless ERP implementation process, ensuring a smooth transition and minimal disruption to your business. 
                We analyze your requirements, configure the software, and provide comprehensive training to ensure optimal utilization.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3">Custom ERP Development</h3>
              <p className="text-gray-600">
                For businesses with unique needs, our talented developers can create customized ERP solutions tailored to your specific industry and workflows. 
                We understand that one size doesn't fit all, and our custom ERP development ensures that you have a system that perfectly aligns with your requirements.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3">POS System Integration</h3>
              <p className="text-gray-600">
                Integrate our advanced POS system seamlessly into your existing infrastructure for efficient sales and inventory management. 
                Our POS solutions are designed to simplify the checkout process, track inventory in real-time, and provide valuable insights for better decision-making.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3">ERP and POS Support</h3>
              <p className="text-gray-600">
                We provide ongoing technical support and maintenance for our ERP and POS solutions, ensuring that your systems are always up and running smoothly. 
                Our dedicated support team is available to address any issues promptly and provide timely updates and enhancements.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3">Data Migration and Integration</h3>
              <p className="text-gray-600">
                If you're transitioning from legacy systems or need to integrate data from various sources, our team can handle the complex task of data migration and integration. 
                We ensure the seamless transfer of data, maintaining data integrity throughout the process.
              </p>
            </div>
          </div>
        </div>
